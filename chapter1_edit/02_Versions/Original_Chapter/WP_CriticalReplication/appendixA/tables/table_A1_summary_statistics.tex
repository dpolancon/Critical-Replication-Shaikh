...
\bottomrule
\end{longtable}
\note{Source: Real Economic Analysis (\url{https://www.realecon.org/data}), Shaikh (2016) data companions. Variables constructed per Appendix~\ref{tab:app_glossary}. Dummy variables are impulse indicators with mean $1/65 \approx 0.0154$.}